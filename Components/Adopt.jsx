...
const districtCoordinates = {
  ...
  Pudukkottai: [10.3663, 78.765],
  Thanjavur: [10.7905, 79.139],
...
>>>>>>> 25878366038e0948ccec78c42f66448fc5c77caa
  const allAgencies = [
    ...
    {
      name: "Association for the Stray Dogs Sterilisation",
      district: "Chennai",
    },
    { name: "Newlife Foundation", district: "Chennai" },
    {
      name: "Coimbatore Animal Welfare Society (CAWS)",
      district: "Coimbatore",
    },
    ...
    {
      name: "Tiruchirappalli Pet Adoption Center",
    ...
    {
      name: "Tiruvannamalai Pet Care Organization",
    ...
    {
      name: "Erthamalai Environmental Awareness Movement (TEAM)",
      district: "Dharmapuri",
    },
    {
      name: "Sustainable Health Education and Development Trust",
      district: "Dharmapuri",
    },
    ...
    {
      name: "Terra Anima Trust, Animal Welfare in the Nilgiris",
      district: "Ooty",
    },
  ...
  return (
    <div className="adoption-form-container">
      <video autoPlay muted loop id="bg-video">
        <source
          src="https://videos.pexels.com/video-files/2796080/2796080-uhd_2560_1440_25fps.mp4"
          type="video/mp4"
        />
